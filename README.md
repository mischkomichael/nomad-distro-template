![docker image](https://github.com/mischkomichael/nomad-distro-template/actions/workflows/docker-publish.yml/badge.svg)


# mischkomichael's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of mischkomichael.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/mischkomichael/nomad-distro-template.git
    ...
    ```sh
    curl-L -o nomad-distro-template.zip "https://github.com/mischkomichael/nomad-distro-template/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/mischkomichael/nomad-distro-template:main` for the services
...
and advanced configuration, see the [nomad-helm-charts](https://github.com/mischkomichael/nomad-helm-charts) repository.
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/mischkomichael/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/mischkomichael/nomad-distro-template/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/mischkomichael/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/mischkomichael/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/mischkomichael/nomad-distro-template/manifests/main": unauthorized`
